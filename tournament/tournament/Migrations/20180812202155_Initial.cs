        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxParticipantPerTeam = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParticipantTeams", x => new { x.ParticipantId, x.TeamId });
                    table.ForeignKey(
                        name: "FK_ParticipantTeams_Participants_TeamId",
                        column: x => x.TeamId,
                        principalTable: "Participants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ParticipantTeams_Teams_TeamId",
                        column: x => x.TeamId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastModified = table.Column<DateTime>(nullable: false),
                    Created = table.Column<DateTime>(nullable: false),
                    SequenceNr = table.Column<int>(nullable: false),
                    Date = table.Column<DateTime>(nullable: false),
                    TournamentId = table.Column<int>(nullable: false),
                    WinnerGoesToId = table.Column<int>(nullable: true),
                    LoserGoesToId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
